...
<body class="page-body page-body--rating">
    ...
    <main>
        <section class="rating">
            <div class="rating__wrapper rating__wrapper--top">
              <h1 class="visually-hidden">Пользовательский pейтинг компаний</h1>
              <h2 class="rating__title rating__title--top">Рейтинг компаний для вас</h2>
              <div class="rating__custom-long">
                <ul class="rating__subtitle rating__subtitle--tablet-user rating__subtitle--top">
                  <li class="rating__name">Компания</li>
                  <li class="rating__name rating__name--check rating__name--value">Оценка<span></span></li>
                  <li class="rating__name rating__name--check">Цены<span></span></li>
                  <li class="rating__name rating__name--check rating__name--rew">Отзывы<span></span></li>
                  <li class="rating__name rating__name--check">Фото<span></span></li>
                  <li class="rating__name">Гарантия</li>
                  <li class="rating__name">Надежность</li>
                </ul>
                <div class="rating__table rating__table--top">
                  <div class="rating__cell rating__cell--top  rating__cell--custom">
                    <div class="rating__item rating__item--custom rating__item--user">
                      <h3 class="rating__subtitle rating__subtitle--intro rating__subtitle--custom">Компания</h3>
                      <a class="rating__item-link" href="https://studia-remontov.ru" target="_blank">
                        <div class="rating__text">
                          <img class="rating__img rating__img--custom" src="assets/img/logo-studia-small.svg"
                    ...
                    <div class="rating__item rating__item--custom">
                      <h3 class="rating__subtitle rating__subtitle--intro rating__subtitle--custom">Оценка</h3>
                      <p class="rating__value rating__value--star">4.9</p>
                    </div>
                    <div class="rating__item rating__item--custom">
                      <h3 class="rating__subtitle rating__subtitle--intro rating__subtitle--custom">Цены</h3>
                      <p class="rating__value">$$$</p>
                    </div>
                    <div class="rating__item rating__item--custom">
                      <h3 class="rating__subtitle rating__subtitle--intro rating__subtitle--custom">Отзывы</h3>
                      <p class="rating__value rating__value--buble"><a class="rating__link-reviews" href="#">150 <span>отзывов</span></a></p>
                    </div>
                    <div class="rating__item rating__item--custom">
                      <h3 class="rating__subtitle rating__subtitle--intro rating__subtitle--custom">Фото</h3>
                      <p class="rating__value">100</p>
                    </div>
                    <div class="rating__item rating__item--custom">
                      <h3 class="rating__subtitle rating__subtitle--intro rating__subtitle--custom">Гарантия</h3>
                      <p class="rating__value">Есть</p>
                    </div>
                    <div class="rating__item rating__item--custom rating__item--safety">
                      <h3 class="rating__subtitle rating__subtitle--intro rating__subtitle--custom">Надежность</h3>
                      <p class="rating__value">
                        <svg width="16" height="16" class="rating__value-safety">
                          <use xlink:href="assets/img/sprite.svg#safety"></use>
                        </svg>
                      </p>
                    </div>
                  </div>
                  <div class="rating__cell rating__cell--top  rating__cell--custom">
                    ...
                    <div class="rating__item rating__item--custom">
                      <h3 class="rating__subtitle rating__subtitle--intro rating__subtitle--custom">Отзывы</h3>
                      <p class="rating__value rating__value--buble"><a class="rating__link-reviews" href="#">1500 <span>отзывов</span></a></p>
                    </div>
                    <div class="rating__item rating__item--custom">
                      <h3 class="rating__subtitle rating__subtitle--intro rating__subtitle--custom">Фото</h3>
                      <p class="rating__value">100</p>
          ...
          <section class="feedback">
            <div class="feedback__wrapper feedback__wrapper--top">
              ...
              <form class="feedback__form" method="post" action="#" id="callBackRatingCustom">
            ...
            <div class="footer__flex">
                <div class="footer__nav">
                    ...
                    <ul class="footer__list">
                        ...
                        <li class="footer__item"><a class="footer__link" href="rating.html">Топ компаний</a></li>
                        <li class="footer__item"><a class="footer__link" href="onboarding.html">Создать свой
                                рейтинг</a></li>
                    </ul>
                </div>
                <div class="footer__nav">
                    ...
                    <ul class="footer__list">
                        <li class="footer__item"><a class="footer__link" href="compare.html">Сравнить компании</a>
                        </li>
                ...
                <div class="footer__nav">
                    ...
                    <ul class="footer__list">
                        <li class="footer__item"><a class="footer__link" href="article.html">Как выбрать</a></li>
                        <li class="footer__item"><a class="footer__link" href="#">Компании</a></li>
                        <li class="footer__item"><a class="footer__link" href="company.html">О нас</a></li>
                    </ul>
                </div>
