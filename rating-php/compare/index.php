...
<body class="page-body page-body--rating">
    ...
    <main>
        <section id="top" class="compare">
            <div class="compare__wrapper">
                <h1 class="compare__title">Сравнить компании</h1>
                <form class="compare__form" id="formCompare" method="post">
                        <div class="compare__select-block">
                            <select class="compare__select">
                        ...
                        <p class="compare__desc">Сравнение компаний проводится по 6 параметрам. Вам будет предоствален сравнительный анализ
                            по каждому параметру. Вы можете выбрать те параметры которые вас интересует, или посмотреть полный сравнительные
                            анализ компаний</p>
                        <div class="compare__btn">
                            <button type="submit" class="compare__btn-prev">выбрать параметры</button>
                            <a class="compare__btn-next btn-valid" href="/comparedcompany/">сравнить</a>
                        </div>
                </form>
            </div>
        </section>
